...
class BootReceiver : BroadcastReceiver() {
    ...
    internal fun scheduleServiceWatchdog(context: Context) {
    ...
    companion object {
        ...
        internal const val PREFS_NAME = "mock_gps_prefs"
        internal const val KEY_AUTO_START = "auto_start_enabled"
        internal const val KEY_PER_APP_ENABLED = "per_app_enabled"
